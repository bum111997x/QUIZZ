            ...
            <div class="activity-grid">
                <div class="activity-card">
                    ...
                    <form action="<?= BASE_URL . 'quiz/luu-tao-moi'?>" method="post">
                            <input type="text" hidden name="id" value="<?= $_GET['subject_id']?>">
                        ...
                        <div style="margin: 16px">
                            ...
                            <input type="text" name="shuffle" style="width:200px">
                        </div>
                        <div style="margin: 16px">
...
<!--        <input type="time" name="duration_minutes">-->
<!--    </div>-->
<!--    <div>-->
...
<!--    </div>-->
<!--    <div>-->
<!--        <button type="submit" name="add-quiz">Lưu</button>-->
<!--    </div>-->
<!--</form>-->